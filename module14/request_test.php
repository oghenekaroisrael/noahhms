                           ...
                           <div class="header">
                            ...
                            <div class="content">
								...
								<span class="pal" style="padding-bottom: 10px;">
									...
									<?php } ?>
									<div class="row">
										You Have Selected <input type="text" id="count" name=""> Test(s).
										<div id="checked_values">
...
<script type="text/javascript">
	...
	s(document).ready(function() {
		s('form').submit(function(e){
			...
			s.ajax({
				type: "POST",
				data: s('form').serialize() + "&val=" + id + "&doc=" + doc + "&ins=newTestRequest",
				url: "../func/verify.php",
				success: function(res) {
					if(res == "Done"){
						window.location = "lab_results?id="+id;
					}else{
