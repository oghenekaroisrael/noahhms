                                        	...
                                        	<td>
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														<li><a href="lab_results?id=<?php echo $aid; ?>">Case Note</a></li>
														<li class="divider"></li>
														<li><a href="chart?id=<?php echo $p_id; ?>&ipid=<?php echo $aid; ?>">Patient Chart</a></li>
														<li class="divider"></li>
														<li><a href="progress?id=<?php echo $p_id; ?>&ipid=<?php echo $ipid; ?>&pid2=<?php echo $aid; ?>">Progress Note</a></li>
														<li class="divider"></li>
								...
								<nav aria-label="...">
									<ul class="pagination">
										<?php if (($pn > 1)) {
											?>
									    <li class="page-item">
											<a class="page-link" href="in_patients.php?page=<?php echo (($pn-1));?>" tabindex="-1">Previous</a>
										</li><?php }
										if (($pn - 1) > 1) {
										    ?>
										    <li class="page-item">
												<a class="page-link" href="in_patients.php?page=1">1</a>
											</li>
											<li class="page-item">
												<a class="page-link">...</a>
											</li>
										...
										for ($i = ($pn - 1); $i <= ($pn + 1); $i ++) {
										    ...
										    ?>
										<li class="page-item">
											<a href="in_patients.php?page=<?php echo $i; ?>" class='<?php echo $class; ?>'><?php echo $i; ?></a>
										</li>
										    <?php
										}
										...
										if (($totalPages - ($pn + 1)) > 0) {
										    ...
										    ?>
										    <li class="page-item">
											<a href="in_patients.php?page=<?php echo $totalPages; ?>"class='<?php echo $class; ?>'><?php echo $totalPages; ?></a>
										</li>
										    <?php
										}
										?>
										    ...
										    if (($row > 1) && ($pn < $totalPages)) {
										        ?>
										        <li class="page-item">
													<a class="page-link" href="in_patients.php?page=<?php echo (($pn+1));?>"><span>Next</span></a> 
										        <?php
										    }
										    ?>
																			</ul>
