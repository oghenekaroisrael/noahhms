...
if($num > 0){
	...
	while($row = mysqli_fetch_array($read)){
			...
			<button class="btn btn-info" onclick="var y = parseInt(document.getElementById('qty').value); window.location='process_r.php?id=<?php echo $p; ?>&s=<?php echo $sid; ?>&st=<?php echo $st; ?>&quantity='+ y;">Request For Stock</button>
			</td>
			</tr>
			<?php
