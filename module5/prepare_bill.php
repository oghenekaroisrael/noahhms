<?php 
	...
	$aid = $_GET['id'];
	database::getInstance()->update_bed_bill($aid);
...
<?php 
	if(isset($_GET['status']) && $_GET['status'] === "done2"){
		?>
		<div class="alert alert-success">
			Sent Sucessfully To Account!
		</div>
		<?php
	}
                            ...
                            <div class="content">
                            	<div class="row">
									...
									<div class="col-lg-3">
                            			<div class="jumbotron">
                            				<h5>Balance:</h5>
                            				<b>&#8358; <?php if (($the_bill-$deposit) < 0) {
                            					echo "0";
                            				}else{
                            					echo $the_bill-$deposit;
                            				}?></b>
                            			</div>
                            		</div>
                            	</div>
...
function sure(ID,name){ 
		...
		function sure2(ID,bill){ 
        	...
        	a.notify({
            	icon: 'pe-7s-info',
            	message: "Are you sure you want to Send Bill To Account?</br><button type='button' class='btn pop-btn' onclick='pay("+ID+","+bill+")'>Send To Account  </button>"
