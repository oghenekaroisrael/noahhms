		...
		<div class="col-lg-12">
			<div class="row">
				...
				<div class="col-md-10">
					...
					<p><?php  if(!isset($adm_note)){echo '';}else{echo ucwords($adm_note);}?></p>
				</div>
			</div>
		</div>
	</div>
                            ...
                            <div class="row">
                            	...
                            	<div class="col-lg-12" style="height: 300px;overflow-x: scroll;">
                            		<table class="table table-bordered">
                            			...
                            			<tr>
                            				...
                            				<td><?php if(!isset($tabs)){echo '';}else{echo $tabs;}?></td>
                            				<td><?php if(!isset($dosage)){echo '';}else{echo $dosage;}?></td>
                            				<td><?php if(!isset($dur)){echo '';}else{echo $dur;}?></td>
