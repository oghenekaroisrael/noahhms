					 ...
					 <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="head-cont" style="width: 500px;">
                                SALES REPORT FROM <?php echo $date_from; ?> TO <?php echo $date_to; ?>
                            </div>
                            </center>
                            </div>
                            <div class="content" style="padding-bottom: 100px;">
                                ...
                                <div class="row">
                                    <table class="table table-stripped">
                                        ...
                                        <?php
                                            $pending1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 0");
                                            while ($pending2  = mysqli_fetch_assoc($pending1)) {
                                             ...
                                             $full1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 1");
                                            while ($full2  = mysqli_fetch_assoc($full1)) {
                                                $expected1 += intval($full2['SUM(to_pay)']);
                                                $recieved1 += intval($full2['SUM(amount)']);
                                            }

                                             $part1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 2");
                                            ...
                                            $recieved2 = $part2['SUM(amount)'];
                                             ...
                                             $comp = mysqli_query($db, "SELECT SUM(status),SUM(amount) FROM company_bill WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."'");
                                            while ($comp2  = mysqli_fetch_assoc($comp)) {
                                            $expected5 = $comp2['SUM(amount)'];
                                            $recieved5 = $comp2['SUM(status)'];
                                            }

                                             $wave1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 5");
                                            while ($wave2  = mysqli_fetch_assoc($wave1)) {
                                            $expected3 = $wave2['SUM(to_pay)'];
                                            $recieved3 = $wave2['SUM(amount)'];
                                            }

                                             $def1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 4");
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <b style="float: right;">Total Expected: </b>
                                                </td>
                                                <td><?php 
                                                    echo $Total1 = $expected+$expected1+$expected2+$expected3+$expected4+$expected5;
                                                ?></td>
                                                <td><b>Total Recieved: </b><?php 
                                                    echo $all_balance1 = $recieved+$recieved1+$recived2+$recieved5;
                                                    ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"></td>
                                                <td><b>Total Balance: </b><?php echo $Total1 - $all_balance1; ?></td>
                                            </tr>
                                        </tbody>
                                        <thead>
                                            <th>#</th>
                                	...
                                	<div class="row">
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                                                    $count = 1; 
                                                    $notarray = mysqli_query($db, "SELECT * FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' ".$join."");
                                                    $Total = 0;
                                                    $all_balance = 0;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php
                                                                    ...
                                                                    echo $get_name['surname']." ".$get_name['first_name'];
                                                                        ...
                                                                        $nam = mysqli_query($db, "SELECT full_name FROM in_sales WHERE sales_id = '".$oid."'");
                                                                    $get_name =mysqli_fetch_assoc($nam);
                                                                    echo $get_name['full_name'];
                                                                    }
 
                                                                ?></td>
                                                                <td><?php echo substr(trim($lab_test.$c), 1,-5); ?></td>
                                                                <td>&#x20A6;<?php echo $to_pay;?></td>
                                                                <td>&#x20A6;<?php if($status != 4 || $status != 5){echo $balance;$all_balance += $to_pay;}else{echo $to_pay;$all_balance += $to_pay; }?></td>
                                                    ...
                                                    <?php
                                                        ...
                                                        $b = 1;
                                                            $notarray = database::getInstance()->join_insales_and_account($oid);
                                                                foreach($notarray as $row):
                                                            $pharm_stock_id = $row['description'];
                                                            $amt = $row['amount'];
                                                            $qty = $row['quantity'];
                                                           // $status = $row['status'];
                                                            ...
                                                            endforeach;
                                                                    ...
                                                                    echo $get_name['surname']." ".$get_name['first_name'];
                                                                        ...
                                                                        echo database::getInstance()->get_name_from_id("full_name","in_sales","sales_id",$oid);
                                                                    }
                                                                ?></td>
                                                                        <td><?php echo substr($dname.$b, 1);?></td>
                                                                        <td>&#x20A6;<?php echo $to_pay;?></td>
                                                                        <td>&#x20A6;<?php if($status != 4){echo $balance;$all_balance += $to_pay;}else{echo $to_pay;$all_balance += $to_pay; }?></td>
                                                                        <td>
                                                                    <?php 
                                                                        if ($status == 0) {
                                                                            $stat = "Pending";
                                                        ...
                                                        $notarray = database::getInstance()->select_from_where2('patients', 'id',$patient_id);
                                                            ...
                                                            $card_type = $row['card_type'];
                                                                ...
                                                                ?></td>
                                                                        ...
                                                                        <td>&#x20A6;<?php if($status != 4){echo $balance;}else{echo $to_pay;}?></td>
                                                                        <td>
                                                                    <?php 
                                                                        if ($status == 0) {
                                                                            $stat = "Pending";
                                                        ...
                                                        $notarray = database::getInstance()->select_from_where2("xray_requests","link",$frnt);
                                                                ...
                                                                <td>&#x20A6;<?php if($status != 4){echo $balance;}else{echo $to_pay; }?>
                                                                </td>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php
                                                                    ...
                                                                    echo $get_name['surname']." ".$get_name['first_name'];
                                                                ?></td>
                                                                <td><?php echo $e_name = database::getInstance()->get_name_from_id_and_id2('description','in_sales','sales_id',$oid,'type',10); ?></td>
                                                                <td>&#x20A6;<?php echo $fee;?></td>
                                                                <td>&#x20A6;<?php if($status != 4){echo $balance;}else{echo $to_pay;}?></td>
                                                                <td>
                                                                    <?php 
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $count++;?></td>
                                                                <td><?php
                                                                    $nam = mysqli_query($db, "SELECT name FROM antenatal WHERE id = ".$patient_id."");
                                                                    $get_name =mysqli_fetch_assoc($nam);
                                                                    echo ucwords($get_name['name']);
                                                                ?></td>
                                                                <td>Immunization</td>
                                                                <td>&#x20A6;<?php echo $fee;?></td>
                        ...
                        <div class="card1">
                            ...
                            <?php
                                            ...
                                            while ($pending2  = mysqli_fetch_assoc($pending1)) {
                                             ...
                                             $full1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_paid BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 1");
                                            while ($full2  = mysqli_fetch_assoc($full1)) {
                                                $expected1 += intval($full2['SUM(to_pay)']);
                                                $recieved1 += intval($full2['SUM(amount)']);
                                            }

                                             $part1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_paid BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 2");
                                            while ($part2  = mysqli_fetch_assoc($part1)) {
                                            $expected2 = $part2['SUM(to_pay)'];
                                            $recieved2 = $part2['SUM(amount)'];
                                            }
                                            ...
                                            $recieved5 = $comp2['SUM(status)'];
                                             ...
                                             $wave1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE date_paid BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 5");
                                            while ($wave2  = mysqli_fetch_assoc($wave1)) {
                                            $expected3 = $wave2['SUM(to_pay)'];
                                            $recieved3 = $wave2['SUM(amount)'];
                                            }
                            ...
                            <div class="row" style="margin-top: 20px;">                                
                                ...
                                <div class="col-md-3" id="minimal-5">
                                    <center>
                                        <h2>&#x20A6;<?php echo $expected; ?></h2>
                                        <h4>Deffered Payment</h4>
                                    </center>
                                </div>
                                <div class="col-md-3" id="minimal-6">
                                    <center>
                                    ...
                                    <div class="row">
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                                                    $count = 1; 
                                                    $notarray = mysqli_query($db, "SELECT *, SUM(to_pay) FROM accounts WHERE date_paid BETWEEN '".$date_from."' AND '".$date_to."' ".$join." GROUP BY item");
                                                    $Total = 0;
                                                    $all_balance = 0;
                                                    foreach($notarray as $rowa):
                                                        $type = $rowa['item'];
