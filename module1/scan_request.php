                           ...
                           <div class="header">
                            ...
                            <div class="content">
                                <form id="form">
									...
									<div class="col-sm-8">
									<?php  
									$noarray = database::getInstance()->select_from_ord1('scan_types','category','ASC');
									...
									<div class="row">
									<?php 
										$not = database::getInstance()->select_scan_to($opow['scan_cat_id']);
										foreach($not as $row){
								  ?>
...
<script type="text/javascript">
	...
	s(document).ready(function() {
		s('form').submit(function(e){
			...
			s.ajax({
				type: "POST",
				data: s('form').serialize() + "&val=" + id + "&doc=" + doc + "&ins=newScanRequest_front&pat=" + pat,
				url: "../func/verify.php",
				success: function(res) {
					if(res == "Done"){
						window.location = "patients?stat=success";
					}else{
