                ...
                <div class="row">
					 <div class="col-md-4">
					 	<center>
					 			<div class="monthly_boxes red">
					 				...
					 				<div class="link">
					 					<a class="btn-link" href="monthly_debit.php"><i class="fas fa-info-circle"></i>Click Here To See All Debit Transactions</a>
					 				</div>
					 			</div>
					 	</center>
					 </div>
					 <div class="col-md-4">
					 	<center>
					 			<div class="monthly_boxes green">
					 				...
					 				<span class="box_title">Credit Transactions</span>
					 				<i class="fas fa-credit-card"></i>
					 				<div class="link">
					 					<a class="btn-link" href="monthly_credit.php"><i class="fas fa-info-circle"></i>Click Here To See All Credit Transactions</a>
					 				</div>
					 			</div>
					 	</center>
					 </div>
					 <div class="col-md-4">
					 	<center>
					 			<div class="monthly_boxes cyan">
					 				...
					 				<div class="link">
					 					<a class="btn-link" href="monthly.php"><i class="fas fa-info-circle"></i>Click Here To See All</a>
					 				</div>
					 			</div>
					 	</center>
					 </div>
                 ...
                 <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">All Monthly Credit Details </h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$userDetails = Database::getInstance()->select_gen_credit();
