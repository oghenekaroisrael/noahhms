...
<?php include_once 'inc/admin_header.php';?>
 ...
 <?php include 'inc/main_header.php';?>
        ...
        <div class="content">
			...
			<a href="new_category1" style="margin-bottom:10px;" class="btn btn-primary pull-right btn-flat btblack">
					<i class="entypo-plus-circled"></i> New Scan Category
			</a>
			</div>
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">All Scan Categories</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_from_ord1('scan_types','scan_cat_id','DESC');
											foreach($notarray as $row):
										?>
                                        <tr>
                                        	<td style="width: 10%;"><?php echo $count++;?></td>
                                        	<td style="width: 75%;"><i class="fas fa-folder-o"></i><?php echo $row['category']; ?></td>
                                        	...
                                        	<td style="width: 15%;">
												<div class="btn-group">
													...
													<li><a href="edit_category1?edit=<?php echo $row['scan_cat_id']; ?>">Edit</a></li>
													<li class="divider"></li>
													<li><a onclick="delet(<?php echo $row['scan_cat_id']; ?>)">Delete</a></li>
													</ul>
												</div>
											</td>
                                        </tr>
		...
		var val = ID;
		 document.getElementById("load").style.display = "block";
          s.ajax({
            type: 'post',
            url: '../func/del.php',
            data: "val=" + val +  '&ins=delCategory1',
             success: function(data)
            {
				document.getElementById("load").style.display = "block";
				if (data === 'Done') {
					console.log(data);
					window.location = 'scan_types';
				  }
				  else {
