...
<?php include_once 'inc/admin_header.php';?>
 ...
 <?php include 'inc/main_header.php';?>
        ...
        <div class="content">
			...
			<a href="new_visitor" style="margin-bottom:10px;" class="btn btn-primary pull-right btn-flat btblack">
					<i class="entypo-plus-circled"></i> New Visitor
			</a>
			</div>
                                        	...
                                        	<td><i class="fas fa-user-md"></i>
                                        		<?php
													...
													foreach($userDetails as $ow):
														echo $name = $ow['last_name']." ".$ow['first_name'];	
													endforeach; 
												?>
                                        	...
                                        	<td>
                                        		<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														...
														<li class="divider"></li>
														<li><a href="editv_note?edit=<?php echo $id; ?>">Edit</a></li>
													   <li class="divider"></li>
