									  ...
									  $count = 1;
                                        ...
                                        <tr>
                                        	...
                                        	<td>
                                        		...
                                        		<?php 
                                                $noarray = database::getInstance()->select_from_where('staff','user_id
                                                    ',$d_id);
                            while ($doct = $noarray->fetch(PDO::FETCH_ASSOC)) {
                                        	...
                                        	<td style="width: 20%;">
                                        		...
                                        		<?php
                                                $noarray = database::getInstance()->select_from_where('patient_appointment','id
                                                    ',$id);
                            while ($pi = $noarray->fetch(PDO::FETCH_ASSOC)) {
