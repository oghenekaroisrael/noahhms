                ...
                <div class="row">
					 <div class="col-md-4">
					 	<center>
					 			<div class="monthly_boxes red">
					 				...
					 				<span class="box_title">Debit</span>
					 				<i class="fas fa-money"></i>
					 				<div class="link">
					 					<a class="btn-link" href="monthly_debit.php"><i class="fas fa-info-circle"></i>Click Here To See All Debit</a>
					 				</div>
					 			</div>
					 	</center>
					 </div>
					 <div class="col-md-4">
					 	<center>
					 			<div class="monthly_boxes green">
					 				...
					 				<span class="box_title">Credit</span>
                 ...
                 <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">All Monthly Debit Details </h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$userDetails = Database::getInstance()->select_gen_debit();
