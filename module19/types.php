 ...
 <?php include 'inc/main_header.php';?>
        ...
        <div class="content">
			...
			<a href="new_category" style="margin-bottom:10px;" class="btn btn-primary pull-right btn-flat btblack">
					<i class="entypo-plus-circled"></i> New Xray Category
			</a>
			</div>
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">All Xray Categories</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_from_ord1('xray_types','xray_cat_id','DESC');
											foreach($notarray as $row):
										?>
                                        <tr>
                                        	<td style="width: 10%;"><?php echo $count++;?></td>
                                        	<td style="width: 75%;"><i class="fas fa-folder"></i><?php echo $row['category']; ?></td>
                                        	...
                                        	<td style="width: 15%;">
												<div class="btn-group">
													...
													<li><a href="edit_category?edit=<?php echo $row['xray_cat_id']; ?>">Edit</a></li>
													<li class="divider"></li>
													<li><a onclick="delet(<?php echo $row['xray_cat_id']; ?>)">Delete</a></li>
													</ul>
												</div>
											</td>
                                        </tr>
