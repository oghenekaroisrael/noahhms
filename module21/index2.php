...
<?php 
	...
	$patDetails = Database::getInstance()->select_from_where('patients', 'id', $patid);
				foreach($patDetails as $qw1):
					$name1 = $qw1['title']." ".$qw1['surname'].$qw1['middle_name']." ".$qw1['first_name'];
						$surname = $qw1['surname'];
				endforeach; 
?>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php 
											$count = 1; 
											$notarray = database::getInstance()->select_from_where_ord('patient_appointment','patient_id',$patid,'id','DESC');
                                        ...
                                        <tr>
                                        	...
                                        	<td><?php echo date('d M Y',strtotime($date_added)); ?></td>
                                        	...
                                        	<td>
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														<li><a href="lab_results?id=<?php echo $id; ?>&p=<?php echo $patid; ?>">Case Note</a></li>
