            ...
            <div class="container-fluid">
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                           <div class="header">
                                <h4 class="title">Update Donor Details</h4>
                            </div>
                            ...
                            <div class="content">
                                <form id="schedule">
									...
									<?php 
										...
										$data = database::getInstance()->select_from_where("donors","donor_id",$value);
										foreach ($data as $row) {
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="name" placeholder="Full Name"  value="<?php echo $row['name']; ?>">
	                                            </div>
	                                        </div>
										</div>
									</div>
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="father_name" placeholder="Father's Full Name" value="<?php echo $row['fathers_name']; ?>">
	                                            </div>
	                                        </div>
										</div>
									</div>
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="weight" placeholder="Body Weight" value="<?php echo $row['body_weight']; ?>">
	                                            </div>
	                                        </div>
										</div>
									</div>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Update Donor</button>
...
<script type="text/javascript">
	...
	a(function () {
		a('#schedule').on('submit', function (e) {
			...
			a.ajax({
				type: "POST",
				data: a('#schedule').serialize() + '&ins=editDonor' + "&val=" + id ,
				url: "../func/edit.php",
