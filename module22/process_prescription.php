                        ...
                        <div class="card">
                           <div class="header">
                            ...
                            <div class="content">
                                ...
                                <button type="submit" class="btn btn-info btn-fill pull-right">Send To Front Desk</button>
                                <div class="clearfix"></div>
                                </form>
                            </div>
			...
			s.ajax({
				...
				success: function(res) {
					if(res.value === "Done"){
						...
						s("#get_result").html("<div class='alert alert-success'>Total: "+ res.value2 +"</div>").fadeIn("slow");
						console.log(res);
					}
				}
			});
