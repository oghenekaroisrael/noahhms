<?php 
    ...
    $search_param2 = "date_added BETWEEN '".$from_date."' AND '".$to_date."' AND company_id = ".$comp_id." AND patient_id = ";
}else{
    $from_date = "";
    $to_date = "";
    $search_param1 = "company_id = ".$comp_id." GROUP BY patient_id";
    $search_param2 = "company_id = ".$comp_id." AND patient_id = ";
    unset($_POST);
}
...
<div class="card" style="padding: 30px; margin-top: 40px;">
    ...
    <div class="col-md-4">
        <div style="position: relative;top: 30px;">
           <p>Invoice From : <?php echo $date_from; ?></p>
           <p>Invoice To : <?php echo $date_to; ?></p>
           <br>
        </div>
    </div>
</div>
                                    ...
                                    <div class="row">
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                                                    $count = 1;
                                                    $sump = mysqli_query($db, "SELECT SUM(to_pay),patient_id FROM `accounts` WHERE ".$search_param1."");
                                                    while ($person = mysqli_fetch_assoc($sump)) {
                                                        $per = $person['patient_id'];
                                                        $notarray = mysqli_query($db, "SELECT * , SUM(to_pay) FROM `accounts` WHERE ".$search_param2.$per." GROUP BY item");
                                                        $num = mysqli_num_rows($notarray);
                                                ...
                                                <tr>
                                                <td colspan="11"></td>   
                                                    <td><b>&#x20A6;<?php echo $person['SUM(to_pay)']; ?></b></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
