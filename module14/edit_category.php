            ...
            <div class="container-fluid">
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                           <div class="header">
                                <h4 class="title">Edit Xray Category</h4>
                            </div>
                            <div class="content">
                                <form>
								 <?php
                            $noarray = database::getInstance()->select_from_where('xray_types','xray_cat_id',$value);
...
<script>	
	...
	s(document).ready(function() {
		s('form').submit(function(e){
			...
			s.ajax({
				type: "POST",
				data: s('form').serialize() + "&val=" + id + "&ins=editCategory",
				url: "../func/edit.php",
