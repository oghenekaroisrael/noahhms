...
<?php include_once 'inc/admin_header.php';?>
 ...
 <?php include 'inc/main_header.php';?>
        ...
        <div class="content">
			...
			<a href="new_stock_w" style="margin-bottom:10px;" class="btn btn-primary pull-right btn-flat btblack">
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">All Warehouse Stock</h4>
                            </div>
                            <div class="content table-responsive table-full-width" style="overflow-x: scroll;">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_from_ord1('warehouse_stock','id','DESC');
                                        ...
                                        <tr>
                                        	...
                                        	<td><i class="fas fa-clock-o"></i><?php echo $exp_date;?></td>
                                        	<td>
												<div class="btn-group">
													...
													<li><a href="edit_stock_w?edit=<?php echo $row['id']; ?>">Edit</a></li>
													<li class="divider"></li>
...
<div class="loader" id="load" style="display:none ">
 ...
 function out(name){ 
            ...
            s.notify({
                icon: 'pe-7s-trash',
                message: "<b>"+name+"</b> Is Out Of Stock"
