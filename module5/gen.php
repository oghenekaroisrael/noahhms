                                	...
                                	<div class="row">
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                         ...
                                         <?php  
                                                    $count = 1; 
                                                    $notarray_a = mysqli_query($db, "SELECT * FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' ".$join."");
                                                    $Total = 0;
                                                    $all_balance = 0;
                                                    foreach($notarray_a as $rowa):
                                                        $type = $rowa['item'];
                                                        $to_pay = $rowa['to_pay'];
                                                        $amount = $rowa['amount'];
                                    ...
                                    <div class="row">
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                                                    $count = 1; 
                                                    $notarray = mysqli_query($db, "SELECT *, SUM(to_pay) FROM accounts WHERE date_added BETWEEN '".$date_from."' AND '".$date_to."' ".$join." GROUP BY item");
                                                    $Total = 0;
                                                    $all_balance = 0;
                                                    foreach($notarray as $rowa):
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>&#x20A6;<?php echo $to_pay;?></td>
                                                                <td>&#x20A6;<?php if($status != 4){echo $balance;}else{echo $to_pay;$all_balance += $to_pay; }?></td>
                                                                <td>
                                                                    <?php 
                                                                        if ($status == 0) {
                                                                            $stat = "Pending";
                                                    ...
                                                    <?php
                                                        ...
                                                        $Total += $to_pay;
                                                        $all_balance += $balance;
                                                        $coun = database::getInstance()->count_from_where('in_sales','sales_id',$oid);
                                                        if ($coun>0) {
                                                            $notarray = database::getInstance()->join_insales_and_account($oid);
                                                                foreach($notarray as $row):
                                                            $pharm_stock_id = $row['description'];
