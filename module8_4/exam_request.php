<?php 
	ob_start();
	session_start();
	$pageTitle = "New Examination Request";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Examination Request</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table id="pro" class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_from_where_ord('exam_request','ward_id',4,'id','DESC');
                                        	...
                                        	<td>
                                        		<?php
													...
													foreach($userDetails as $qw):
														echo $pname = $qw['title']." ".$qw['middle_name']." ".$qw['surname'];
