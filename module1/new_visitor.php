            ...
            <div class="container-fluid">
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                           <div class="header">
                                <h4 class="title">Today's Visiting Log</h4>
                            </div>
                            ...
                            <div class="content">
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
													...
													<input type="text" name="vname" class="form-control" placeholder="Visitor's Name">
	                                            </div>
	                                        </div>
										</div>
									</div>
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
													...
													<input type="tel" name="vtel" class="form-control" placeholder="Visitor's Tel">
	                                            </div>
	                                        </div>
										</div>
									</div>
									...
									<div class="col-md-3">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<input type="text" name="vaddress" class="form-control" placeholder="Visitor's Address">
												</div>
											</div>
										</div>
									</div>
                               ...
                               <div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="row">
											<div class="col-md-12">
												...
												<textarea name="vreason" class="form-control" style="height: 100px; font-size: 18px; text-align: left">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Add Log</button>
...
<script type="text/javascript">
	...
	a(function () {
		...
		a('#appt').on('submit', function (e) {
			...
			a.ajax({
				type: "POST",
				data: a('#appt').serialize() + '&s_id=' + s_id + '&ins=newLog&user=<?php echo $user_id; ?>',
				url: "../func/verify.php",
