                            ...
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
									  $count = 1;
											$notarray = database::getInstance()->select_from_physiotherapy_front();
                                        ...
                                        <tr>
                                        	...
                                        	<td style="width: 20%;"><i class="fas fa-user"></i>
                                        		<?php
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														<?php 
															if($statusS != 0){
														?>
													<li><a href="lab_results<?php echo $front2; ?>?id=<?php echo $front; ?>&pid=<?php echo $id; ?>&ref=<?php echo $row['link_ref']; ?>">View Case File</a></li>
														<div class="divider"></div>
														<li><a href="upload_doc<?php echo $front2; ?>?id=<?php echo $front; ?>&pid=<?php echo $id; ?>&ref=<?php echo $row['link_ref']; ?>">Add Therapy Plan</a></li>
													<?php } else { ?>
