                            	...
                            	<div class="row">
                                       <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control" name="name" placeholder="Name" value="<?php echo $ow['name'];?>"  disabled>
                                            </div>
                                        </div>
									</div>
...
<script>	
	...
	s(document).ready(function() {
		s('#ediSt').submit(function(e){
			...
			s.ajax({
				type: "POST",
				data: s('#ediSt').serialize() + "&id=" + id + "&tname=" + `<?php echo $new_name; ?>` + "&ins=editStock2",
				url: "../func/edit.php",
