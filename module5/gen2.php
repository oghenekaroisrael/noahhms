					 ...
					 <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="head-cont" style="width: 900px;">
                                SALES REPORT FOR    <b><?php echo $depts; ?></b> FROM <?php echo $date_from; ?> TO <?php echo $date_to; ?>
                            </div>
                            </center>
                            </div>
                                    ...
                                    <table class="table table-stripped">
                                        ...
                                        <?php
                                            ...
                                            while ($pending2  = mysqli_fetch_assoc($pending1)) {
                                             ...
                                             $full1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE item ".$dept." AND date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 1");
                                            while ($full2  = mysqli_fetch_assoc($full1)) {
                                                $expected1 += intval($full2['SUM(to_pay)']);
                                                $recieved1 += intval($full2['SUM(amount)']);
                                            }

                                             $part1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE item ".$dept." AND date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 2");
                                            ...
                                            $recieved5 = $comp2['SUM(status)'];
                                             ...
                                             $wave1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE item ".$dept." AND date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 5");
                                            while ($wave2  = mysqli_fetch_assoc($wave1)) {
                                            $expected3 = $wave2['SUM(to_pay)'];
                                            $recieved3 = $wave2['SUM(amount)'];
                                            }

                                             $def1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE item ".$dept." AND date_added BETWEEN '".$date_from."' AND '".$date_to."' AND payment_status = 4");
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                ?></td>
                                                <td><?php 
                                                    echo $recieved+$recieved1+$recived2;
                                                    ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                	...
                                	<div class="row">
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                                                    $count = 1; 
                                                    $notarray = mysqli_query($db, "SELECT * FROM accounts WHERE item ".$dept." AND  date_added BETWEEN '".$date_from."' AND '".$date_to."' ".$join."");
                                                    $Total = 0;
                                                    $all_balance = 0;
                                                    ...
                                                    <?php
                                                        ...
                                                        $notarray = database::getInstance()->select_from_where2("xray_requests","link",$frnt);
                                                                ...
                                                                <td>&#x20A6;<?php if($status != 4){echo $balance;}else{echo $to_pay;$all_balance += $to_pay; } $all_balance += $balance;?>
                                                                </td>
                        ...
                        <div class="card1">
                            ...
                            <?php
                                            ...
                                            while ($pending2  = mysqli_fetch_assoc($pending1)) {
                                             ...
                                             $full1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE  item = 3 AND  date_added BETWEEN '".$date_from."' AND '".$date_to."'");
                                            while ($full2  = mysqli_fetch_assoc($full1)) {
                                                $expected1 += intval($full2['SUM(to_pay)']);
                                                $recieved1 += intval($full2['SUM(amount)']);
                                            }

                                             $part1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE item = 8 AND  date_added BETWEEN '".$date_from."' AND '".$date_to."'");
                                            while ($part2  = mysqli_fetch_assoc($part1)) {
                                            $expected2 = $part2['SUM(to_pay)'];
                                            $recieved2 = $part2['SUM(amount)'];
                                            }
                                            ...
                                            $recieved5 = $comp2['SUM(status)'];
                                             ...
                                             $wave1 = mysqli_query($db, "SELECT SUM(to_pay),SUM(amount) FROM accounts WHERE  item = 8 AND  date_added BETWEEN '".$date_from."' AND '".$date_to."'");
                                            while ($wave2  = mysqli_fetch_assoc($wave1)) {
                                            $expected3 = $wave2['SUM(to_pay)'];
                                            $recieved3 = $wave2['SUM(amount)'];
                                            }
                                    ...
                                    <div class="row">
                                      ...
                                      <thead>
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                                                    $count = 1; 
                                                    $notarray = mysqli_query($db, "SELECT *, SUM(to_pay) FROM accounts WHERE  item ".$dept." AND date_added BETWEEN '".$date_from."' AND '".$date_to."' ".$join." GROUP BY item");
                                                    $Total = 0;
                                                    $all_balance = 0;
                                                    foreach($notarray as $rowa):
                                                        $type = $rowa['item'];
