        ...
        <div class="content">
            <div class="container-fluid">
				...
				<table class="table table-bordered">
					...
					<tr>
						<td colspan="4" style="font-size: 24px;"><b>Scientist: </b>
							<?php
								$sql_sci = mysqli_query($db, "SELECT first_name, last_name FROM staff WHERE user_id = ".$sci_id."");
								while ($get_sci = mysqli_fetch_assoc($sql_sci)) {
									$sci_name = $get_sci['last_name']." ".$get_sci['first_name'];
