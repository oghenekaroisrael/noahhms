...
if($num > 0){
	...
	while($row = mysqli_fetch_array($read)){
			...
			<button value="<?php echo $catt;?>" class="btn btn-info" onclick="var y = parseInt(document.getElementById('qty').value);window.location='process.php?id=<?php echo $p; ?>&s=<?php echo $sid; ?>&quantity='+ y;"> Add To Sales</button>
			</td>
			</tr>
			<?php
			}else{
