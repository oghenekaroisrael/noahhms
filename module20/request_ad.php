										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <input class="form-control" name="diagnosis" placeholder="Number of Tabs" value="<?php echo $diagnosis?>">
	                                            </div>
	                                        </div>
										</div>
									</div>
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <input class="form-control" name="tabs" placeholder="Number of Tabs">
	                                            </div>
	                                        </div>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                <label>Dosage</label>
	                                                <input class="form-control" name="dosage" placeholder="Dosage">
	                                            </div>
	                                        </div>
										</div>
									</div>
