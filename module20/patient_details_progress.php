												...
												<?php 
													...
													<td>
															<div class="row">
						                                       <div class="col-md-12">
						                                            <div class="form-group">
						                                                <input disabled="disabled" type="number" class="form-control" id="price1" name="price[]" value="0"/>
						                                            </div>
						                                        </div>
															</div>
													</td>
													...
													<td>
															<div class="row">
						                                       <div class="col-md-12">
						                                            <div class="form-group">
						                                                <input type="number" class="form-control" id="price1" name="price[]" value="0"/>
						                                            </div>
						                                        </div>
															</div>
													</td>
...
<script type="text/javascript">
	...
	a(function () {
		...
		a('#case').on('submit', function (e) {
			...
			a.ajax({
				type: "POST",
				data: a('#case').serialize()+ '&p_id=' + p_id + '&doc_id=' +doc_id + '&id=' + value + '&ins=newCaseD_progress',
				url: "../func/verify.php",
        ...
        a('#drug_list').on('submit', function (e) {
			...
			a.ajax({
				...
				success: function(res) {
					a("#get_result").html(res).fadeIn("slow");
					console.log(res);
					window.location = "patient_details_progress.php?id=<?php echo $_GET['id'] ?>";
				}
			});
        });
