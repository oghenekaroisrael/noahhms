...
<?php include_once 'inc/admin_header.php';?>
 ...
 <?php include 'inc/main_header.php';?>
        ...
        <div class="content">
			...
			<a href="new_scan" style="margin-bottom:10px;" class="btn btn-primary pull-right btn-flat btblack">
					<i class="entypo-plus-circled"></i> New Scan
			</a>
			</div>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_from_ord1('scan','id','DESC');
											foreach($notarray as $row):
												$notarray = database::getInstance()->select_from_where('scan_types','scan_cat_id',$row['category']);
												foreach ($notarray as $category):
										?>
                                        <tr>
                                        	<td><?php echo $count++;?></td>
                                        	<td><i class="fas fa-video-camera"></i><?php echo $row['name']; ?></td>
                                        	...
                                        	<td>
												<div class="btn-group">
													...
													<li><a href="edit_scan?edit=<?php echo $row['id']; ?>">Edit</a></li>
													<li class="divider"></li>
