            ...
            <div class="container-fluid">
				...
				<table class="table table-bordered">
			        ...
			        <?php 
			         ...
			         <tr>
			         	<th></th>
			         	<th class="text-center">Total Bill: <?php echo ($total); ?></th>
			         </tr>
					 
					 <tr>
			         	<th></th>
			         	<th class="text-center">Total Deposit: <?php echo $deposit; ?></th>
			         </tr>
					 <?php
						if($total > $deposit){
							?>
							<tr>
								<th></th>
								<th class="text-center">Balance: <?php echo intval($total - $deposit); ?></th>
							 </tr>
							<?php
							...
							<tr>
								<th></th>
								<th class="text-center">Refund: <?php echo intval($deposit - $total); ?></th>
							 </tr>
							<?php
						}
					 ?>
