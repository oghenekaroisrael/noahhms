<?php 
	ob_start();
	session_start();
	$pageTitle = "New Dispensing Chart";
                           ...
                           <div class="header">
                            ...
                            <div class="content">
                                <form id="appt">
										...
										<div class="row">
	                                       <div class="col-md-12">
												 <select  name="pharm" class="form-control">
													...
													<?php 
														$notray = database::getInstance()->select_from_ord1('pharm_stock','id','DESC');
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="meth" placeholder="Method Of Administration" >
	                                            </div>
	                                        </div>
										</div>
									</div>
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Add To Chart</button>
...
<script type="text/javascript">
	...
	a(function () {
		...
		a('#appt').on('submit', function (e) {
			...
			a.ajax({
				type: "POST",
				data: a('#appt').serialize() + '&ipid=' + ipid +  '&by=' + by + '&ins=newDis',
				url: "../func/verify.php",
