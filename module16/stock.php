                            ...
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_from_ord('caf_stock','id','DESC');
                                        ...
                                        <tr>
                                        	...
                                        	<td>&#x20A6;<?php echo number_format($selling);?></td>
...
<div class="loader" id="load" style="display:none ">
    ...
    s("#pro").DataTable();
		...
		function sure(ID,name){ 
        	...
        	s.notify({
            	icon: 'pe-7s-trash',
            	message: "Are you sure you want to delete <b>"+name+"</b> from stock ? </br><button type='button' class='btn pop-btn' onclick='delet("+ID+")'>Delete</button>"
