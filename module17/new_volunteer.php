            ...
            <div class="container-fluid">
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                           <div class="header">
                                <h4 class="title">Volunteer's Details</h4>
                            </div>
                            <div class="content">
                                <form id="patient">
								 <?php
							...
							?>
							    <?php if($photo != ""){ ?>
								<div class="header">
                                    <div class="pinshure" style="margin-bottom:5%;"><img style= "border-radius: 45%; "src="../photo/<?php echo $photo; ?>"/></div>
                                </div>
                                <?php } ?>
								<div class="col-md-6">
