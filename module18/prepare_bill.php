                            ...
                            <div class="content">
                            	<div class="row">
                            		...
                            		<div class="col-lg-4">
                            			<div class="jumbotron">
                            				<h5>Deposit:</h5>
                            				<b>&#8358; <?php echo number_format($deposit); ?></b>
                            			</div>
                            		</div>
                            		<div class="col-lg-4">
                            			<div class="jumbotron">
                            				<h5>Bills:</h5>
                            				<b>&#8358; <?php echo number_format($the_bill = substr(intval($deduct) + intval($disc),1)); ?></b>
                            			</div>
                            		</div>
                            		<div class="col-lg-4">
                            			<div class="jumbotron">
                            				<h5>Refund:</h5>
                            				<b>&#8358; <?php echo number_format($refund+$disc); ?></b>
                            			</div>
                            		</div>
                            	</div>
			                                    	...
			                                    	$coun =1;
			                                    		...
			                                    		$count_it = database::getInstance()->select_from_where2('`in-patients`','app_id',$_GET['id']);
			                                    			...
			                                    			<tr>
			                                    				...
			                                    				<td style="<?php if ($nature == 1 || $nature == 4) {echo "color: green;";}else{echo "color: red;";}?>"><?php echo "&#8358;".number_format($amount); ?></td>                             
