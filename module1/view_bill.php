            ...
            <div class="container-fluid">
				...
				<table class="table table-bordered">
			        ...
			        <?php 
			        	...
			        	foreach ($bills as $bill) {
			        		...
			        		<tr>
			        			...
			        			<td  class="text-center">
			        				<?php 
			        				if ($bill['discount'] <=0 || empty($bill['discount'])) {
			        					$total += $bill['to_pay']; 
			        					echo number_format($bill['to_pay']); 
			        				}else{
			        					$total -= $bill['discount']; 
			        					echo number_format($bill['discount']); 
			        				}
			        				?>
								</td>
			        		</tr>
			         ...
			         <tr>
			         	<th></th>
			         	<th class="text-center">Total: <?php echo number_format($total); ?></th>
			         </tr>
			        </table>
