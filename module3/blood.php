<?php
	ob_start();
	session_start();
	$pageTitle = "Blood Screening Requests";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">All Blood Screening Requests </h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_blood_screening($pn); 

											//total pages
											$totalPages = database::getInstance()->count_select_blood_test();

											foreach($notarray as $row):
											$id = $row['blood_test_group_id'];
										?>
                                        <tr>
                                        	...
                                        	<td><i class="fas fa-user"></i>
                                        		<?php 
														$userDetails = Database::getInstance()->select_from_where2('donors', 'donor_id', $row['donor_id']);
                                        	...
                                        	<td>
												<div class="btn-group">
													...
													<li><a href="view_test1?id=<?php echo $row['link_ref']; ?>">Send Lab Result</a></li>
													<li><a href="view_test_lab1.php?id=<?php echo $row['link_ref']; ?>">View Test Result</a></li>
