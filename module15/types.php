...
<?php include_once 'inc/admin_header.php';?>
 ...
 <?php include 'inc/main_header.php';?>
        ...
        <div class="content">
			...
			<a href="new_type" style="margin-bottom:10px;" class="btn btn-primary pull-right btn-flat btblack">
					<i class="entypo-plus-circled"></i> New Blood Group
			</a>
			</div>
                ...
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">All Blood Groups </h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_from_ord1('blood_groups','blood_group_id','DESC');
											foreach($notarray as $row):
											$id = $row['blood_group_id'];
											$type = $row['blood_group'];
										?>
                                        <tr>
                                        	...
                                        	<td>
												<div class="btn-group">
													...
													<li><a href="edit_type?edit=<?php echo $id; ?>">Edit</a></li>
													<li class="divider"></li>
													<?php 
														if ($row['status'] == 1) {
															?>
		...
		var val = ID;
		 document.getElementById("load").style.display = "block";
          s.ajax({
            type: 'post',
            url: '../func/del.php',
            data: "val=" + val +  '&ins=delBloodGroup',
		...
		var val = ID;
		 document.getElementById("load").style.display = "block";
          s.ajax({
            type: 'post',
            url: '../func/edit.php',
            data: "val=" + val +  '&ins=actBloodGroup',
             success: function(data)
            {
				document.getElementById("load").style.display = "block";
				if (data === 'Done') {
