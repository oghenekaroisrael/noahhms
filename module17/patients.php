                                        ...
                                        <tr>
                                        	...
                                        	<td width="12%">
												<div class="btn-group">
													...
													<li><a href="edit_patient?edit=<?php echo $row['id']; ?>">Update</a></li>
													<li class="divider"></li>
													<li><a href="new_volunteer?edit=<?php echo $row['id']; ?>">Volunteer Details</a></li>
													<li class="divider"></li>
													<li><a href="patient_history?id=<?php echo $row['id']; ?>">History</a></li>
													<li class="divider"></li>
													<li><a href="ipd?id=<?php echo $row['id']; ?>">Admissions</a></li>
													<li class="divider"></li>
													<li ><a href="request_physiotherapy.php?pid=<?php echo $row['id']; ?>&staff=<?php echo $user_id; ?>&front=<?php echo $row['front_desk']; ?>">Request Physiotheraphy</a></li>
													<li class="divider"></li>
