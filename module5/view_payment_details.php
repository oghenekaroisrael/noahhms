                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <div class="row">
                               	...
                               	<div class="col-lg-4">
                               		...
                               		<div class="col-lg-4">
                               		 	<h4>Balance: <b style="color: red;"><?php echo $bala =$amo - $data1 - $inv; ?></b></h4>
                               		</div>
                               </div>
                            </div>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table id="pro"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									 		<?php  
													$notarray = database::getInstance()->select_from_where61('accounts','front_desk', $ref,'patient_id',$_GET['pid'],'id');
