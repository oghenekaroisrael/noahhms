					 			...
					 			<form id="company">
					 				<div class="col-md-6">
	                                    <div class="form-group">
			                                <label>Charge</label>
			                                <input type="text" class="form-control" name="name" placeholder="Charge">
			                            </div>
			                        </div>
			                        ...
			                        <button type="submit" class="btn btn-info btn-fill pull-right">Add Charge</button>
