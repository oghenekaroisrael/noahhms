	  ...
	  <!--  MAIN -->
       <div class="content">            
            <div class="container-fluid">
            	<div class="row">
            		<div class="col-lg-12">
            			<h3 class="title text-center"> REQUESTED SCANs</h3>
            		</div>
            		<hr>
            	</div>
            	...
            	<div class="row">            		
            		<div class="col-lg-12">
            			<?php 
								$dif = 0;
								$view_all = Database::getInstance()->select_view_scans($link);
            			foreach ($view_all as $row):
						$labTn = Database::getInstance()->select_from_where2('scan','id', $row['name']); 
