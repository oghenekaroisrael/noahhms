                            			...
                            			<table id="pro"class="table table-hover table-striped">
				                                    ...
				                                    <tbody>
													 <?php
															...
															$sql = mysqli_query($db, "SELECT * FROM patient_xray_result WHERE patient_id = ".$pid." AND app_id = ".$value." ORDER BY  id DESC");
															if ($sql) {
                            			...
                            			<div class="col-md-12">
                            				<table class="table table-striped table-hover">
                            					...
                            					<tbody>
                            						<?php 
                            				$db =  mysqli_connect("localhost","root","","noahhms");
															$sql = mysqli_query($db, "SELECT * FROM therapy_plans WHERE patient_id = ".$pid." AND appointment_id = ".$value." ORDER BY  id DESC");
															$count_t = 1;
                            					...
                            					if (!empty($plan) AND $plan  > 0) {
                            						while ($tplan = mysqli_fetch_assoc($sql)) {
                            							...
                            							<tr>
                            								...
                            								<td width="18%">
                            									<i class="fas fa-clock-o"></i><?php echo $tplan['time_added']; ?></td>
                            								<td width="12%">
                            									<div class="btn-group">
																	<button type="button" class="btn btn-info">...</button>
																	<button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
