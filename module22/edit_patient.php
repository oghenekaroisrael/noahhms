										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
													...
													<?php
														$userDetails = Database::getInstance()->select_from_where('card_types', 'id', $card_type);
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<?php
														$userDetails = Database::getInstance()->select_from_where('companies', 'id', $company);
														foreach($userDetails as $ow):
															$idd = $ow['id'];
															$namse = $ow['company_name'];
														
													?>
													<option selected="selected" value="<?php if($idd != ""){ echo $idd; }?>"><?php if($namse != ""){ echo $namse;} ?></option>
													<?php
														endforeach;
									...
									<div class="col-md-3"  style="display: none;" id="family_card_cont">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
	                                                <label>Family</label>
	                                                <select class="form-control" name="family"  id="family_card">
													<option>Select Family</option>
													<?php
														$userDetails2 = Database::getInstance()->select_from_where('families', 'id', $family);
														foreach($userDetails2 as $ow2):
															$idd2 = $ow2['id'];
															$namse2 = $ow2['family_name'];
														
													?>
													<option selected="selected" value="<?php if($idd2 != ""){ echo $idd2; }?>"><?php if($namse2 != ""){ echo $namse2;} ?></option>
													<?php
														endforeach;
														$userDetails3 = Database::getInstance()->select('families');
														foreach($userDetails3 as $ow3):
															$ictd3 = $ow3['id'];
															$namee3 = $o3['family_name'];	
														
													?>
													<option value="<?php echo $ictd3;?>"><?php echo $namee3;?></option>
													<?php endforeach; ?>
												</select>
	                                            </div>
											</div>
