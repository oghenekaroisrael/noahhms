                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php 
											$count = 1; 
											$notarray = database::getInstance()->select_from_where2_ord_group('patient_appointment','specialty',1,'id','patient_id','DESC',$pn);

											//total pages
											$totalPages = database::getInstance()->count_from_where_ord2_group('patient_appointment','specialty',1,'id','patient_id','DESC');
