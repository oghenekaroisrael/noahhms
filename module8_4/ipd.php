										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="admin_no" placeholder="Admission No." value="<?php echo $ad_id;?>" >
	                                            </div>
	                                        </div>
										</div>
									</div>
	                                       ...
	                                       <div class="col-md-12">
	                                            <div class="form-group">
													...
													<?php
														...
														$userDetails = Database::getInstance()->select_from_where2('staff', 'user_id', $row['nurse']);
	                                       ...
	                                       <div class="col-md-12">
	                                            <div class="form-group">
													...
													<?php
														...
														$userDetails = Database::getInstance()->select_from_where2('staff', 'user_id', $row['doctor_id']);
														foreach($userDetails as $ow):
															$did = $ow['user_id'];
															$name = $ow['first_name']." ".$ow['last_name'];	
									...
									<div class="col-md-6" style="display: none;">
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                <label>Ward</label>
	                                                <input type="text" class="form-control" name="ward" placeholder="Ward" value="1">
	                                            </div>
	                                        </div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-6">
	                                            <div class="form-group">
													...
													<?php
														$notarray = database::getInstance()->select_from_where('card_types','id',$card_type);
													foreach($notarray as $row):
													...
													endforeach;
													?>
			                                        <input type="text" class="form-control" name="company" placeholder="Card Type" value="<?php echo $card_name; ?>">
			                                     </div>
	                                        </div> 
