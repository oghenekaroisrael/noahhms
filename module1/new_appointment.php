										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
													...
													<?php 
														$types = Database::getInstance()->select('doctor_types');
														foreach($types as $ow):
															$id = $ow['type_id'];
															$name = $ow['name'];	
	                                       ...
	                                       <div class="col-md-12">
	                                            <div class="form-group">
	                                                ...
	                                                <select class="form-control" name="doctor" id="doctor">
																																																			<?php 
																																																			$docs = Database::getInstance()->select_from_where_ord('staff','role_id',5,'user_id','DESC');
																																																			foreach($docs as $ow):
																																																				$id = $ow['user_id'];
...
<script type="text/javascript">
	...
	a(function () {
		...
		a('#specialty').on('change', function (e) {
