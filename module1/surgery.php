...
<?php include_once 'inc/admin_header.php';?>
 ...
 <?php include 'inc/main_header.php';?>
        ...
        <div class="content">
			...
			<a href="new_surgery" style="margin-bottom:10px;" class="btn btn-primary pull-right btn-flat btblack">
					<i class="entypo-plus-circled"></i> New Surgery Patient
			</a>
			</div>
                <div class="row">
					 <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Surgery Patients </h4>
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
									    <?php
											...
											$id = $row['surgery_perm_id'];
											$p_id = $row['patient_id'];
											$accept = $row['accepted_by'];
											$date = $row['signed_when'];
											$name = "";
										?>
                                        <tr>
								...
								<nav aria-label="...">
									<ul class="pagination">
										<?php if (($row > 1) && ($pn > 1)) {
											?>
									    <li class="page-item">
											<a class="page-link" href="surgery.php?page=<?php echo (($pn-1));?>" tabindex="-1">Previous</a>
										</li><?php }
										if (($pn - 1) > 1) {
										    ?>
										    <li class="page-item">
												<a class="page-link" href="surgery.php?page=1">1</a>
											</li>
											<li class="page-item">
												<a class="page-link">...</a>
											</li>
										...
										for ($i = ($pn - 1); $i <= ($pn + 1); $i ++) {
										    ...
										    ?>
										<li class="page-item">
											<a href="surgery.php?page=<?php echo $i; ?>" class='<?php echo $class; ?>'><?php echo $i; ?></a>
										</li>
										    <?php
										}
										...
										if (($totalPages - ($pn + 1)) > 0) {
										    ...
										    ?>
										    <li class="page-item">
											<a href="surgery.php?page=<?php echo $totalPages; ?>"class='<?php echo $class; ?>'><?php echo $totalPages; ?></a>
										</li>
										    <?php
										}
										?>
										    ...
										    if (($row > 1) && ($pn < $totalPages)) {
										        ?>
										        <li class="page-item">
													<a class="page-link" href="surgery.php?page=<?php echo (($pn+1));?>"><span>Next</span></a> 
										        <?php
										    }
										    ?>
																			</ul>
