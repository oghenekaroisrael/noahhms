                        ...
                        <div class="card">
                           <div class="header">
                            ...
                            while ($row = $noarray->fetch(PDO::FETCH_ASSOC)) {
								...
								$bedbef = Database::getInstance()->get_name_from_id('bed', 'bed','bed_id',$row['bed_no']);
                            	?>
								<div class="col-md-6">
										<div class="row">
										...
										<div class="row">
	                                       <div class="col-md-12">
	                                            <div class="form-group">
													...
													<option value="<?php echo $row['bed_no'];?>"><?php echo $bedbef;?></option>
													<?php
														$beda = Database::getInstance()->select_from_wherenot_ord('bed', 'bed_id', $row['bed_no'], 'bed_id','DESC');
														foreach($beda as $ow):
															$bedid = $ow['bed_id'];
															$bed = $ow['bed'];	
													?>
